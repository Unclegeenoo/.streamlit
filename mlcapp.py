...
df_fin_usd = df_fin[df_fin['Classification'].str.contains('USD')].copy()
df_fin_rub = df_fin[~df_fin['Classification'].str.contains('USD')].copy()
...
def main():
    ...
    section = st.sidebar.radio("Go to", ("General", "Financial Data", "Attendance Data"))
...
def show_general_stats():
    ...
    with tab2:
        ...
        html_map_src = "data:text/html;charset=utf-8," + urllib.parse.quote(html_map)
        st.iframe(html_map_src, height=500)
...
###Team practices should go before skill practices
    ...
    team_practice_data = df_att.loc[df_att['Type'] == 'Team Practice', :].copy()
...
############################################
    ...
    skills_practice_data = df_att.loc[df_att['Type'] == 'Skills Practice', :].copy()
...
def show_financial_analysis():
    ...
    if selected_subsection == "Summary":
        ...
        df_fin_usd = df_fin[df_fin['Classification'].str.contains('USD')].copy()
        df_fin_rub = df_fin[~df_fin['Classification'].str.contains('USD')].copy()
        total_turnover_usd1 = df_fin_usd['Sum'].abs().sum()
        total_turnover_usd = "{:,.2f}".format(total_turnover_usd1)

        total_turnover_rub1 = df_fin_rub['Sum'].abs().sum()
        total_turnover_rub = "{:,.2f}".format(total_turnover_rub1)
        ...
        with col11:
            ...
            with container:
                ...
                st.plotly_chart(fig_cumulative_sum_rub, width='stretch')
        ...
        with col22:
            ...
            with container:
                ...
                st.plotly_chart(fig_cumulative_sum_usd, width='stretch') 
        ...
        with col111:
            ...
            with st.expander('RUB fund denominated in US Dollars'):
                st.plotly_chart(fig_fund_forex, width='stretch')
        ...
        with col1:
            ...
            with container:
                ...
                with st.expander('Profit/Loss by Month (Grouped)'):                
                    st.plotly_chart(fig_month_rub, width='stretch')

                


                with st.expander('Profit/Loss by Year (Grouped)'): 
                    st.plotly_chart(fig_net_rub, width='stretch')
            ...
            with container:
                ...
                with st.expander('Total Sum Leading Categories'):
                    st.plotly_chart(fig_total_sum_rub, width='stretch')
                
                with st.expander('Transactions per Category'):
                    st.plotly_chart(fig_transactions_rub, width='stretch')

                with st.expander('Profit per Transaction'):
                    st.plotly_chart(fig_profit_loss_rub, width='stretch')
        ...
        with col2:
            ...
            with container: 
                ...
                with st.expander('Profit/Loss by Month (Grouped)'):   
                    ...
                    st.plotly_chart(fig_month_usd, width='stretch')

         

                with st.expander('Profit/Loss by Year (Grouped)'): 
                    st.plotly_chart(fig_net_usd, width='stretch')
            ...
            with container:
                ...
                with st.expander('Profit/Loss per Category USD'):
                    st.plotly_chart(fig_total_sum_usd, width='stretch')
                
                with st.expander('Transactions per Category USD'):
                    st.plotly_chart(fig_transactions_usd, width='stretch')

                with st.expander('Leading Category for P/L per Transaction USD'):
                    st.plotly_chart(fig_profit_loss_usd, width='stretch')
        ...
        equipment_df_rub = df_fin_rub.loc[df_fin_rub['Category'].str.contains('Equipment', case=False, na=False), :].copy()
        # Extract the year from the 'Date' column
        ...
        with col1:
            ...
            with container:
                ...
                st.plotly_chart(fig_equip_rub, width='stretch')
            
            with st.expander('Top Profit for RUB Operations'): 

                st.plotly_chart(fig_op_profit_rub, width='stretch')
                st.markdown("""
                    <p style='text-align: center;'>
            ...
            with st.expander('Top Equipment Operations by Revenue (RUB)'):
                ...
                st.plotly_chart(fig_op_revenue_rub, width='stretch')
                st.markdown("""
                    <p style='text-align: center;'>
        ...
        # Filter the DataFrame for 'Equipment' operations in the 'Category' column
        equipment_df_usd = df_fin_usd.loc[df_fin_usd['Category'].str.contains('Equipment', case=False, na=False), :].copy()
        # Extract the year from the 'Date' column
        ...
        with col2:
            ...
            with container:
                ...
                st.plotly_chart(fig_equip_usd, width='stretch')

            with st.expander('Top Profit for USD Operations'):

                st.plotly_chart(fig_op_profit_usd, width='stretch')
                st.markdown("""
                    <p style='text-align: center;'>
            ...
            with st.expander('Top Equipment Operations by Revenue (USD)'):
                ...
                st.plotly_chart(fig_op_revenue_usd, width='stretch')
                st.markdown("""
                    <p style='text-align: center;'>
...
#############################################################
        ...
        with container:
            ...
            with st.expander('By Year'):
                ...
                field_rental_df = df_fin.loc[df_fin['Operation'] == 'Field Rental', :].copy()
                # Group by year and count the occurrences
                ...
                st.plotly_chart(fig_fieldrental, width='stretch')
        ...
        ####################################################################
            ...
            with st.expander('By Month'):
                ...
                # Show the graph
                st.plotly_chart(fig_rentalmonth, width='stretch')
                st.markdown("""
                    <p style='text-align: center;'>
...
#################################################################
        ...
        # Calculate cumulative unique attendees
            ...
            with st.expander('Total Team Practice Attendees per Month'):
                    st.plotly_chart(fig_tp_mo, width='stretch')
                    st.markdown("""
                            <p style='text-align: center;'>
            ...
            with st.expander('Total Skills Practice Attendees per Month'):
                    st.plotly_chart(fig_sp_mo, width='stretch')
                    st.markdown("""
                            <p style='text-align: center;'>
...
############### Attendance per type ###################
            ...
            # Display the plot
            st.plotly_chart(fig_att_type, width='stretch')
        ...
        with container:
            ...
            st.plotly_chart(fig_int_att, width='stretch')
        ...
        with container:    
            ...
            if selected_name:
                ...
                with col1:
                    ...
                    # Display the centered gauge chart in Streamlit using plotly_chart with width='stretch'
                    
                    with st.expander('Expand'):
                        st.plotly_chart(fig_team_practices, width='stretch')
                ...
                with col2:
                    ...
                    # Display the centered gauge chart in Streamlit using plotly_chart with width='stretch'
                    with st.expander('Expand'):
                        st.plotly_chart(fig_skills_practices, width='stretch')
                ...
                with col4:
                    ...
                    with st.expander('Expand'):
                        st.plotly_chart(fig_total_events, width='stretch')
                ...
                with col5:
                    ...
                    # Display the gauge chart in Streamlit
                    with st.expander('Expand'):
                        st.plotly_chart(fig_time_spent, width='stretch')
